...
class LookaApp : Application() {
    ...
    val db by lazy {
        Room.databaseBuilder(this, LookaDb::class.java, "looka.db")
            .addMigrations(
                LookaDb.MIGRATION_3_4, LookaDb.MIGRATION_4_5, LookaDb.MIGRATION_5_6,
                LookaDb.MIGRATION_6_7, LookaDb.MIGRATION_7_8,
                LookaDb.MIGRATION_8_9, LookaDb.MIGRATION_9_10, LookaDb.MIGRATION_10_11,
                LookaDb.MIGRATION_11_12, LookaDb.MIGRATION_12_13)
