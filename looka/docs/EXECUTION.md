...
> 4. 发版前把本文件从头扫一遍
>
> 最后更新：2026-08-22 · v1.7.1 (15) + **后台 v2 上线**（分站分页/用户画像/留存/信标/Ko-fi钩子/爱发电新令牌）。73 项已勾
...
| V2-7 | 🔴 用户贴信标到 主站/文钞/game/播经台 四站页面（脚本见 §44） | [ ] |
| V2-8 | 用户提供 Ko-fi 验证令牌 → 存 KOFI_VERIFY_TOKEN | [ ] |
